    ...
    const fetchConvertedLeads = async () => {
        ...
        try {
            ...
            if (clientUserIds.size > 0) {
                 const usersQuery = query(collection(firestore, 'users'), where('__name__', 'in', Array.from(clientUserIds)));
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">A list of your referrals that have been converted into projects.</p>
      </div>
       <Card>
            <CardHeader>
                <CardTitle>Your Converted Leads</CardTitle>
                <CardDescription>These are the projects created from clients you referred.</CardDescription>
            </CardHeader>
            <CardContent>
