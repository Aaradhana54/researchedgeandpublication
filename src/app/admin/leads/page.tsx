...
export default function AllLeadsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">All Project Leads</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This is a master list of every project, including those from clients, partners, and website leads.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
