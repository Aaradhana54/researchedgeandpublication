...
const CustomLogoIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path d="M25 90V10H65C79.9183 10 90 20.0817 90 35C90 49.9183 79.9183 60 65 60H25" stroke="currentColor" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
